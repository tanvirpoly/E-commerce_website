                ...
                <form method="POST" action="<?php echo site_url("Quotation/update_Quotation ") ?>">
                  ...
                  <div class="col-md-12 col-sm-12 col-12" >
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          <td>
                            <input type='text' name='productName[]' value="<?php echo $value['pName']; ?>">
                            <input type="hidden" readonly='readonly' name='product_id[]' value="<?php echo $value['productID'];?>">
                          </td>
                          <td>
                            <input type='text' name='capacity[]' value="<?php echo $value['capacity']; ?>">
                          </td> 
                          <td>
                          ...
                          <td>
                            <input type='text' onkeyup='getTotal(<?php echo $value['productID']?>)' id='tp_<?php echo $pid?>' name='tp[]' value='<?php echo $value['salePrice']?>'>
                          </td>
                          <td>
                            <input  type='text' id='totalPrice_<?php echo $pid?>' name='total_price[]' value='<?php echo $value['totalPrice']?>'>
                          </td>
                          <td>
                  ...
                  <div class="row" >
                    <div class="form-group col-md-4 col-sm-4 col-xs-12">
                      ...
                      <input type="text" class="form-control"  name="totalPrice" id="totalPrice" value="<?php echo $quotation['totalPrice']; ?>">
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      <label>Message</label>
                      <textarea type="text" class="form-control" name="message" placeholder="Message"><?php echo $quotation['message']; ?></textarea>
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      <label>Terms & Conditions</label>
                      <textarea type="text" class="form-control" name="terms" id="editor" placeholder="Terms & Conditions"><?php echo $quotation['terms']; ?></textarea>
                    </div>
