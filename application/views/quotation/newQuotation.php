                ...
                <form method="POST" action="<?php echo site_url("Quotation/save_quotation") ?>">
                  <div class="row">
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <input type="date" name="date" class="form-control" value="<?php echo date('d-m-Y') ?>" required >
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <select id="products" class="form-control select2" required>
                    ...
                    <!--  <input type="text" class="form-control" name="sName" placeholder="Shipment Contact Persion" >-->
                    <!--</div>-->
                    <!--<div class="form-group col-md-4 col-sm-4 col-12">-->
