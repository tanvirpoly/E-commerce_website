        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url() ?>Returns/update_preturns" >
                  <input type="hidden" name="prid" value="<?php echo $returns['prid']; ?>" required >
                  <div class="row">
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      <label>Return Date *</label>
                      <input type="text" class="form-control datepicker" name="date" value="<?php echo date('d-m-Y',strtotime($returns['prDate'])) ?>" required >
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <select class="form-control" name="customer" required >
                        ...
                        <option <?php echo ($returns['customerID'] == $value['supplierID'])?'selected':''?> value="<?php echo $value['supplierID'] ?>"><?php echo $value['supplierName']; ?></option>
                        <?php } ?>
                      </select>
                    </div> 
                    <div class="form-group col-md-4 col-sm-4 col-12">
                    ...
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type='text' onkeyup='totalPrice(<?php echo $id ?>)' name='salePrice[]' id='salePrice_<?php echo $id ?>' value="<?php echo $value['pPrice']?>">
                          </td>
                          <td>
                            <input type='text' class='totalPrice'  name='totalPrice[]' readonly id='totalPrice_<?php echo $id ?>' value="<?php echo $value['tPrice']?>">
                          </td>
                          <td>
