          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                ...
                <span style="color: red; float: right;">Need some Update, payment option Not working 100%.</span>
              </div>
                ...
                <table id="example" class="table table-responsive table-bordered" >
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        <?php if($package){ ?><?php echo $package->package; ?><?php } ?>
                      </td>
                      <td>
                        <?php if($years){ ?>
                      ...
                      <td>
                        <?php if($package){ ?>
                        <?php
                        $now2 = date('Y-m-d h:i:s', strtotime($package->regdate. ' + 1 year'));
                        ...
                        $hour2s = floor(($diff2-$year2s*365*60*60*24-$month2s*30*60*60*24-$days*60*60*24)/(60*60));
