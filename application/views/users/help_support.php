                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="button" class="btn btn-info btn-xs msg_view" data-toggle="modal" data-target=".bs-example-modal-msg_view" data-id="<?php echo $value['hs_id']; ?>" ><i class="fa fa-eye"></i> Reply</button>
                        <a class=" btn btn-danger btn-xs" href="<?php echo site_url('User/delete_help_message').'/'.$value['hs_id']; ?>" onclick="return confirm('Are you sure you want to delete this user ?');" ><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>   
                    <?php } ?> 
                  </tbody>
