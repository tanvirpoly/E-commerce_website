                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">      
                      ...
                      <td>
                        ...
                        <?php } if($_SESSION['deleteutype'] == 1){ ?>
                        <a class="btn btn-danger btn-xs" href="<?php echo site_url('User/delete_user_role').'/'.$value['ax_id']?>" ><i class="fa fa-trash"></i></a>
                        <?php } ?>
                      </td>
                    </tr>   
                    <?php } ?> 
