        ...
        <div class="modal-content">
          ...
          <form method="POST" action="<?php echo base_url() ?>Service/save_service_info" >
            ...
            <div class="form-group col-md-12 col-sm-12 col-12">
              ...
              <textarea class="form-control" name="sDetails" placeholder="Service Details Information" rows="3"></textarea>
            </div>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <form method="POST" action="<?php echo base_url() ?>Service/update_service_info" >
            ...
            <div class="form-group col-md-12 col-sm-12 col-12">
              <label>Service Details</label>
              <textarea class="form-control" name="sDetails" id="sDetails" placeholder="Service Details Information" rows="3"></textarea>
            </div>
            <div class="form-group col-md-12 col-sm-12 col-12">
              <label>Status</label>
