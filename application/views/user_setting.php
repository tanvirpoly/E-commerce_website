          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <!--    <div class="info-box" style="background-color:#FFCBCB;color:black;">-->
                ...
                <!--    <div class="info-box" style="background-color:#E7FBBE;color:black;">-->
                <!--      <span class="info-box-icon"><i class="fas fa-align-center"></i></span>-->
                <!--      <div class="info-box-content">-->
                ...
                <div class="col-md-3 col-sm-6 col-12">
                  <a href="<?php echo base_url('Employee') ?>" > 
                    <div class="info-box" style="background-color:#D9D7F1;color:black;">
                      <span class="info-box-icon"><i class="fas fa-align-center"></i></span>
                      <div class="info-box-content">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                  <a href="<?php echo base_url('User') ?>" > 
                    <div class="info-box" style="background-color:#FFFDDE;color:black;">
                      <span class="info-box-icon"><i class="fas fa-align-center"></i></span>
                      <div class="info-box-content">
