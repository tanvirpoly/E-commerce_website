                      ...
                      <div class="d-none" id="dreports">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3 col-sm-3 col-12">
                            ...
                            <div>
                            <select class="form-control select2" name="dproduct"  style="width: 100%;">
                      ...
                      <div class="d-none" id="mreports">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3 col-sm-3 col-12">
                            <label>Select Product *</label>
                            <div>
                            <select class="form-control select2" name="mproduct"  style="width: 100%;">
                              <option value="All">All Product</option>
                              <?php foreach ($product as $value) { ?>
                              <option value="<?php echo $value['productID']; ?>" ><?php echo $value['productName'].' ( '.$value['productcode'].' )'; ?></option>
                              <?php } ?>
                      ...
                      <div class="d-none" id="yreports">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3 col-sm-3 col-12">
                            <label>Select Product *</label>
                            <div>
                            <select class="form-control select2" name="yproduct"  style="width: 100%;">
                              <option value="All">All Product</option>
                              <?php foreach ($product as $value) { ?>
                              <option value="<?php echo $value['productID']; ?>" ><?php echo $value['productName'].' ( '.$value['productcode'].' )'; ?></option>
                              <?php } ?>
