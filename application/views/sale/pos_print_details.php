        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="text-center">
                    ...
                    <span style="text-transform: uppercase; font-size: 18px;"><b>
                            <?php echo $company->com_name; ?>
                        </b></span>
                    <p>
                        <?php echo $company->com_address; ?> <br>Tel:
                        <?php echo $company->com_mobile; ?><br><span
                            style='text-transform: uppercase; font-size: 18px;'>Invoice<span>
                    </p>
                </div>
                <?php
                ...
                ?>
                Date:
                <?php echo $date . ' | ' . $time; ?><br>Invoice No.:
                <?php echo $sales->invoice_no; ?><br>
                <p>Payment Mode:
                    <?php echo $sales->accountType; ?><br>Customer:
                    <?php echo $sales->customerName; ?> <br>Mobile:
                    <?php echo $sales->mobile; ?><br>Address:
                    <?php echo $sales->address; ?><br>
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="no-border border-bottom">Total</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $i = 0;
                        $st = 0;
                        $pdue = $this->pm->get_customer_due_data($sales->customerID);
                        foreach ($salesp as $value) {
                            ...
                            <tr>
                                ...
                                <td class="no-border border-bottom">
                                    <?php echo number_format($value->totalPrice, 1);
                                    $st += $value->totalPrice; ?>
                                </td>
                            </tr>
                        <?php } ?>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="4" class="no-border border-bottom" style="text-align: right;">Sub Total :</th>
                            <td class="no-border border-bottom">
                                <?php echo number_format($st, 2); ?>
                            </td>
                        </tr>
                        <!-- <tr>
                            <th colspan="3" class="no-border border-bottom" style="text-align: right;">Shipping Cost (+)
                                :</th>
                        ...
                        <tr>
                            <th colspan="4" class="no-border border-bottom" style="text-align: right;">Discount (-)
                                <?php if ($sales->discountType == '%') { ?>(
                                    <?php echo $sales->discount; ?>)
                                <?php } ?> :
                            </th>
                            <td class="no-border border-bottom">
                                <?php echo number_format($sales->discountAmount, 2); ?>
                            </td>
                        </tr>
                        <tr>
                            <th colspan="4" class="no-border border-bottom" style="text-align: right;">Total Amount :
                            </th>
                            <td class="no-border border-bottom">
                        ...
                        <tr>
                            <th colspan="4" class="no-border border-bottom" style="text-align: right;">Paid Amount :
                            </th>
                            <td class="no-border border-bottom">
                        ...
                        <tr>
                            <th colspan="4" class="no-border border-bottom" style="text-align: right;">Due Amount :</th>
                            <td class="no-border border-bottom">
                                <?php if ($sales->paidAmount > 0) { ?>
                        ...
                        <!--<tr>-->
                        <!--    <th colspan="4" class="no-border border-bottom" style="text-align: right;">Previous Due :-->
                        <!--    </th>-->
                        <!--    <td class="no-border border-bottom">-->
                        ...
                        <!--            <?php echo number_format(($pdue + (($st + $sales->vAmount) - $sales->discountAmount - $sales->paidAmount - $sales->dueamount)), 2); ?>-->
                        <!--        <?php } ?>-->
                        <!--    </td>-->
                        <!--</tr>-->
                    </tfoot>
            ...
            <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                ...
                <span class="col-xs-12">
                    <a class="btn btn-block btn-warning" href="<?= base_url('Sale') ?>">Back to POS</a>
                </span>
                <div style="clear:both;"></div>
            </div>
        </div>
