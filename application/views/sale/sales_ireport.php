  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Profit Report (Invoice wise)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">Profit Report (Invoice wise)</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Profit Report (Invoice wise)</h3>
              </div>

              <div class="card-body">
                <div class="col-sm-12 col-md-12 col-12">
                  <form action="<?php echo base_url() ?>salesiReport" method="get">
                    <div class="col-md-12 col-sm-12 col-12">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              $tppa = 0;
                              foreach ($pp as $p) { ?>
                                <?php  $tppa += ($p->quantity*$p->pprice); ?>
                              <?php } ?>
                              <?php echo number_format($tppa, 2); $tpa += $tppa; ?>
                            </td>
                            <td>
                              <?php 
                              $tpsa = 0;
                              foreach ($pp as $p) { ?>
                                <?php  $tpsa += $p->totalPrice; ?>
                              <?php } ?>
                              <?php echo number_format($tpsa, 2); $tsa += $tpsa; ?>
                            </td>
                            <td><?php echo number_format($tpsa-$tppa, 2); $tba += $tpsa-$tppa; ?></td>
                          </tr> 
                          <?php } ?>
                        </tbody>
                        <tbody>
