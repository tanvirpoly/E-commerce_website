                      ...
                      <div class="table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($result->paidAmount, 2); $taap += $result->paidAmount; ?></td>
                        ...
                        <tfoot>
                          ...
                          <tr>
                            <th colspan="6" style="text-align: right;">Opening Balance</th>
                            <th><?php echo number_format($supp[0]['balance'], 2); ?></th>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <th><?php echo number_format($tvpa, 2); ?></th>
                          </tr>
                          <tr>
                            <th colspan="6" style="text-align: right;">Total Return</th>
                            <th><?php echo number_format($tra, 2); ?></th>
                          </tr>
                          <tr>
                            <th colspan="6" style="text-align: right;">Due Amount</th>
                            <th><?php echo number_format((($tpa+$supp[0]['balance'])-($taap+$tvpa+$tra)), 2); ?></th>
                          </tr>
                        </tfoot>
                      </table>
                      </div>
